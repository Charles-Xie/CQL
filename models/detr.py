...
def build(args):
    ...
    weight_dict = {}
    if args.hoi:
        weight_dict['loss_image_verb_ce'] = args.image_verb_loss_coef
        ...
        for i in range(0, args.i_dec_layers - 1):
            weight_dict['loss_verb_ce_i{}'.format(i)] = args.verb_loss_coef
        if args.image_verb_loss:
            for i in range(0, args.i_dec_layers - 1):
                weight_dict['loss_image_verb_ce_i{}'.format(i)] = args.verb_loss_coef
    else:
    ...
    if args.hoi:
        ...
        criterion = SetCriterionHOI(args.num_obj_classes, args.num_queries, args.num_verb_classes, matcher=matcher,
                                    ...
                                    verb_loss_type=args.verb_loss_type, image_verb_loss_type=args.image_verb_loss_type,
                                    i_dec_layers=args.i_dec_layers)
    else:
